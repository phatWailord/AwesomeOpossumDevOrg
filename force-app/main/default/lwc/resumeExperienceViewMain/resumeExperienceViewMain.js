    ...
    handleSearch(event){
        ...
        if(searchString == null || searchString == '' || searchString == undefined){
            ...
            for(var job of this.allJobsMasterList){
                ...
                if(job.Skills__c.includes(str) || job.Company_Name__c.includes(str) || job.Name.includes(str)){
                    ...
                    for(var exp of job.Experiences__r){
                        if(exp.Description__c.includes(str) || exp.Name.includes(str) || exp.Skills__c.includes(str)|| exp.Company__c.includes(str) || exp.Job_Title__c.includes(str)){
                ...
                //we want to check each Experience to make sure that there isn't anything there that could match
                    ...
                    for(var exp of job.Experiences__r){
                        ...
                        if(exp.Description__c.includes(str) || exp.Name.includes(str) || exp.Skills__c.includes(str)){
